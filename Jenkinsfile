      ...
      stage('Status'){
        steps{
          script{
            ...
            echo "${operationParam} operation will be performed on schema ${schemaParam}"
      ...
      stage('Update'){
        ...
        steps{
          script {
            ...
            echo "The ${schemaParam} schema has been Updated"
          }
        }
      }      
      stage('Rollback'){
        ...
        steps{
          script{
            ...
            echo "The ${schemaParam} schema has been Rolled back"
          }
        }
      }
    }
